This folder contains the c-code of the implementation of the Rainbow signature scheme optimized for amd64.
...
For the "b" parameter sets over GF(31), the amd64 implementation is
